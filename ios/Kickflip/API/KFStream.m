...
+ (NSDictionary*) JSONKeyPathsByPropertyKey {
    return @{NSStringFromSelector(@selector(streamType)): KFStreamTypeKey,
             ...
             NSStringFromSelector(@selector(startLocation)): @"start_location",
             NSStringFromSelector(@selector(endLocation)): @"end_location",
             NSStringFromSelector(@selector(streamState)): @"stream_state"};
}
